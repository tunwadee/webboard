        ...
        <div class="card-body">
          ...
          <div><a href="formAdd_forum.php"><img src="../img/add.png" width="36" height="35"> ตั้งกระทู้</a></div>
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
			  ...
			  $strSQL = "SELECT w.QuestionID,w.Question,concat(w.View,'/',w.Reply) as viewReply ,c.cate_name,w.ip_address,w.Name ,date_format(w.CreateDate,'%d-%M-%Y %H:%i:%S') as CreateDate,w.status FROM webboard w inner join category c on w.cate_id = c.cate_id where w.Name = '".$_SESSION["session_user"]."'  order by w.CreateDate desc ";
		//echo $strSQL;
